...
plt.figure()
plt.plot(T,y, label=r"$\mathrm{T}$", color='darkred'  ,dashes=[1,0], lw=1.5)
plt.plot(U,y, label=r"$\mathrm{u}$", color='indigo' ,dashes=[1,0], lw=1.5)
plt.xlabel(r"$\mathrm{T(y), u(y)}$")
...
tama    = pp.plotsize(size_wg,size_hf, cmas,plotdef)
plt.figure()
plt.plot(YF,y, label=r"$\mathrm{Y_F}$", color='goldenrod'    ,dashes=[1,0], lw=1.5)
plt.plot(YO,y, label=r"$\mathrm{Y_O}$", color='blue'   ,dashes=[1,0], lw=1.5)
plt.plot(YP,y, label=r"$\mathrm{Y_P}$", color='red',dashes=[1,1], lw=1.5)
