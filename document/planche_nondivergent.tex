...
=
\frac{\partial}{\partial \eta}
\left(\rho^2 \frac{\partial Y_i}{\partial \eta}\right)
-
...
The species equation collapse  in 
a single equation for a passive scalar  
$Z=(Z_1,Z_2,Z_3)$. 
...
the reaction rate . Definning the passive scalars:
...
=
\frac{\partial}{\partial \eta}
\left(\rho^2 \frac{\partial Y_F}{\partial \eta}\right)
-
\frac{\partial}{\partial \eta}
\left(\rho^2 \frac{\partial Y_O}{\partial \eta}\right)
-
...
=
\frac{\partial}{\partial \eta}
\left(\rho^2 \frac{\partial Z_1}{\partial \eta}\right)
-
\frac{1}{\rho}
\left(
    \dot{\omega}_F
...
So,  
\begin{equation}
    \dot{\omega_F}=n{\dot{\omega_O}}
\end{equation}

and the $Z_1$ equation gets 
...
\frac{\partial}{\partial \eta}
\left(
    \rho^2 \frac{\partial Z_1}{\partial \eta}
\right)
,
\end{equation} 
