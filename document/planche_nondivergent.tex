...
meaning that for stoichiometric conditions, 
...
\frac{\partial \psi}{\partial \eta}
\left(
    \frac{\partial Z_{i}}{\partial \chi}
    -
    \frac{\gamma}{2\epsilon}
    \frac{\partial Z_{i}}{\partial \gamma}
\right)
-
\left(
    \frac{\partial \psi}{\partial \chi}
    -
    \frac{\gamma}{2\epsilon}
...
\left(\mu\rho  
\frac{1}{\sqrt{2\epsilon}}
\frac{\partial Z_i}{\partial \gamma}
\right)
\end{equation*} 

\begin{equation*} 
\frac{\partial \sqrt{2\epsilon}F}{\partial \eta}
\left(
    \frac{\partial Z_{i}}{\partial \chi}
    -
    \frac{\gamma}{2\epsilon}
...
-
\left(
    \frac{\partial \sqrt{2\epsilon}F}{\partial \chi}
    -
    \frac{\gamma}{2\epsilon}
    \frac{\partial \sqrt{2\epsilon}F}{\partial \gamma}
\right)
\frac{1}{\sqrt{2\epsilon}}
\frac{\partial Z_{i}}{\partial \gamma}
=
...
By similarity ansatz and defining $Z_i=Z_i(\chi,\gamma)=Z_i(\gamma)$
...
Finally for the total enthalphy equation:
...
By similarity ansatz and defining $H=H(\chi,\gamma)=H(\gamma)$
...
With the similarity assumption the compressible reacting mixing
layer is given by 
...
a ordinary system of equation, providing that 
$u$ and $\rho$ are function only on $\gamma$ or 
with the non-dimensional gas ideal equation
