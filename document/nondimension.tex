The dimesionless equations for a reacting mixing layer
 are obtined using the acoording to \cite{planche1992numerical}:
...
{\color{red}
Vc como autor pode escrever como quiser.
Porem se usar a nomeclatura mais conhecida os revisores e os leitores nao terao trabalho para seguir o texto. O importante  é a fisica, o texto o mais simples possivel.

\[
x=\frac{\bar{x}}{\bar{L}_c}, \qquad 
y=\frac{\bar{y}}{\bar{\delta}}, \qquad 
\]

\[
u=\frac{\bar{u}}{\bar{u}_{\infty}}, \qquad 
v=\frac{\bar{v}}{\bar{v}_{\infty}},
\]

\begin{equation}
\rho=\frac{\bar{\rho}}{\bar{\rho}_{\infty}}, \qquad
T=\frac{\bar{T}}{\bar{T}_{\infty}}, \qquad
h=\frac{\bar{h}}{\bar{h}_{\infty}}, \qquad
p=\frac{\bar{p}}{\bar{p} _{\infty}}, 
\end{equation} 

\begin{equation}
Y_F=\frac{\bar{Y}_F}{\bar{Y}_{F\infty}}, \qquad
Y_O=\frac{\bar{Y}_O}{\bar{Y}_{O\infty}}, 
\end{equation} 

\begin{equation}
\frac{\bar{\mu}} {\bar{\mu}_{\infty}} =
\frac{\bar{k}} {\bar{k}_{\infty}} =
\frac{\bar{c}_v} {\bar{c}_{v\infty}} =
\frac{\bar{c}_p} {\bar{c}_{p\infty}} =
\frac{ \bar{D}_F} {\bar{D}_{F\infty} }= 
\frac{ \bar{D}_O} { \bar{D}_{O\infty} }= 
\frac{\bar{R}}{\bar{R}_\infty}= 
T^n,
\end{equation} 

in which
\[
v_{\infty}=\frac{u_{\infty}\delta_c}{L_c}
\]
...
\end{equation} 
{\color{red} Observe acima. vc misturou variavel adimensional com barra e outras com maiuscula. Vc é o autor, escreve como quiser, mas procura pensar no teu leitor.}
