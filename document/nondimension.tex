...
\left(
\sum_i\rho h_iD_i\frac{\partial Y_i}{\partial y}
\right)
+
Q\Omega
\end{equation} 
...
%+
\frac{\rho_{\infty}T_{\infty}c_{p\infty}D^{n\infty}Y^{n\infty}}{\delta^2}
\frac{\partial }{\partial \overline{y}}
\left(
\sum_i\rho h_i D_i\frac{\partial Y_i}{\partial \overline{y}}
\right)
+
Q\Omega
\end{split}
...
\\
\begin{equation}
\frac{\rho_{\infty}D^{n\infty}Y^{n\infty}T_{\infty}c_{p\infty}}{L_c^2}
\frac{L_c}{\rho_{\infty}U_{\infty}T_{\infty}c_{p\infty}}
=
\frac{D^{n\infty}}{\alpha}
\frac{\alpha}{\nu}
\frac{\nu Y^{n\infty}}{U_{\infty}L_c}
=
\frac{D^{n\infty}}{\alpha}
\frac{\alpha}{\nu}
