...
%\input{nondimension.tex}

\section{Non-divergent form of the compressible equations}
%\input{nondivergent.tex}

\section{Crocco Busemann} %% %%
%\input{croco.tex}

\section{Self-Similarity solution for Reacting Mixing Layer equations}
%\input{similarity.tex}
%\input{new.tex}

\section{Planché Reacting Mixing Layer} %% %%
\input{plache.tex}

\section {Non Dimensional Equations}
%\input{planche_nondimensional.tex}

\section{Planché Non-divergent Consevation Equations} %% %%
%\input{planche_nondivergent.tex}

\section{Base Flow Solution}
%\input{baseflow.tex}

\section{Stability Analysis}
%\input{planche_stability}

\subsection{Stability Equations}
\input{stability_equations_planche.tex}

\subsection{Pseudo-Spectral Solution}
\input{spectral.tex}
