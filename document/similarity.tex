...
\left(\frac{k}{c_p}\varrho\frac{\partial \overline{h}}{\partial y}\right)
-
\frac{Y^{i\infty}}{Pr}
\frac{\partial}{\partial y}
       \left(
...
The total entalphy equation can be writen as 
...
If $D=D_i$ and $c_p$=$c_{pi}$
the non-dimensional form change
because there is not necessity 
to define non dimensional number 
for this variables. Then  
